          ...
          <table width="100%" border="0" cellspacing="5" cellpadding="5">
			...
			<?php } ?>
                <div style="width:80px; height:22px; margin: 0 auto 0 auto;">
                  <a href="formcomprar.php?product_id=<?php echo $row_rselarreglo['customnum']; ?>&productname=<?php echo $row_rselarreglo['nombre_es']; ?>" rel="lyteframe" rev="width: 500px; height: 500px; scrolling: yes;"><img src="images/boton-comprar.png" width="80" height="22" alt="Comprar" border="0" /></a>
                </div>
                <br />
