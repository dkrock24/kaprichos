...
<table width="100%" border="0" cellspacing="0" cellpadding="10">
  <tr>
    <td><!-- InstanceBeginEditable name="WBCMSMAIN" -->
      <?php if($cont_menu == 1) { ?>
      <div class="modaccess" onclick="location.href='menu.php'">
        <table width="100%" border="0" cellspacing="0" cellpadding="3">
          <tr>
            <td height="75" align="center" valign="middle"><img src="../images/icons/blocks.png" width="60" height="60" /></td>
          </tr>
          <tr>
            <td align="center" valign="top">Menú</td>
          </tr>
        </table>
      </div>
      <?php } ?>
      <?php if($cont_seccion == 1) { ?>
      <div class="modaccess" onclick="location.href='secciones.php'">
        <table width="100%" border="0" cellspacing="0" cellpadding="3">
          <tr>
            <td height="75" align="center" valign="middle"><img src="../images/icons/secciones.PNG" width="60" height="60" /></td>
          </tr>
          <tr>
            <td align="center" valign="top">Secciones</td>
          </tr>
        </table>
      </div>
      <?php } ?>
      <?php if($cont_categoria == 1) { ?>
      <div class="modaccess" onclick="location.href='categorias.php'">
        <table width="100%" border="0" cellspacing="0" cellpadding="3">
          <tr>
            <td height="75" align="center" valign="middle"><img src="../images/icons/categories.png" width="60" height="60" /></td>
          </tr>
          <tr>
            <td align="center" valign="top">Categorías</td>
          </tr>
        </table>
      </div>
      <?php } ?>
      <?php if($cont_contenido == 1) { ?>
      <div class="modaccess" onclick="location.href='contenidos.php'">
        <table width="100%" border="0" cellspacing="0" cellpadding="3">
          <tr>
            <td height="75" align="center" valign="middle"><img src="../images/icons/kghostview.png" width="60" height="60" /></td>
          </tr>
          <tr>
            <td align="center" valign="top">Contenido</td>
          </tr>
        </table>
      </div>
      <?php } ?>
