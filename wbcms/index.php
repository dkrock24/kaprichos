...
<table width="100%" border="0" cellspacing="0" cellpadding="10">
  <tr>
    <td><!-- InstanceBeginEditable name="WBCMSMAIN" --><iframe id="homeiframe" src="http://www.wboxinteractive.com/wbcmsiframe.html" frameborder="0"></iframe><!-- InstanceEndEditable --></td>
  </tr>
</table>
</body>
<!-- InstanceEnd --></html>
