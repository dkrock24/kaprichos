...
<title> Servicios - Floristeria Kaprichos</title>
<!-- InstanceEndEditable -->
  ...
  <div id="layout_content">
    <table width="100%" border="0" cellspacing="10" cellpadding="0">
      <tr>
        ...
        <tr>
          <td><h1>Nuestros Servicios</h1></td>
        </tr>
      </table>
      <table width="790" border="0" cellspacing="0" cellpadding="10">
        <tr>
          <td width="33%" valign="top"><h3>Servicios Generales</h3>
              <p><img src="images/gnral.png" alt="Servicios Generales" width="245" height="100" border="0"/></p>
              <ul>
                <li> Servicio las 24 horas del día, los 365 días del año. </li>
              <li> Servicio a domicilio gratis para la ciudad capital. </li>
              <li> Servicio a nivel nacional. (Con recargo ver listado). </li>
            </ul></td>
          <td width="33%" valign="top" style="border-left-color:#747A3C; border-left-style:solid; border-left-width:1px;"><h3>Arreglos </h3>
              <p><img src="images/prueba.jpg" alt="Arreglos" width="245" height="100" border="0" /></p>
              <ul>
<li>Primaverales.</li>
<li>Tropicales.</li>
<li>Orquídeas.</li>
<li>Frutales.</li>
<li>Globos sorpresa.</li>
<li>Arreglos fúnebres.</li>
<li>Chocolates, etc.</li></ul>
</td>
          <td width="33%" valign="top" style="border-left-color:#747A3C; border-left-style:solid; border-left-width:1px;"><h3>Decoraciones</h3>
              <p><img src="images/evento.jpg" alt="Decoraciones" width="245" height="100" border="0" /></p>
              <ul>
<li>Decoración de iglesias.</li>
<li>Bodas.</li>
<li>Primera comunión.</li>
<li>Mesas de Honor.</li>
<li>Baby shower.</li>
<li>Decoraciones de salones.</li>
<li>Eventos de gobierno, etc.</li></ul></td>
        </tr>
      </table>
