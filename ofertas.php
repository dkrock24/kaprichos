...
mysql_select_db($database_conne10, $conne10);
$query_rsarreglos1 = "SELECT * FROM tbl_productos WHERE estatus='1' AND tbl_productos.numerico2>0 ORDER BY tbl_productos.id_producto";
...
<title>Ofertas - Kaprichos Floristeria</title>
<!-- InstanceEndEditable -->
	  ...
	  do { ?>
        <div class="boxarreglo">
          <!--<div class="foto"><a href="arreglos-ver.php?id=<?php echo $row_rsarreglos1['id_producto']; ?>">
           <img src="resize.php?src=/uploaded/mod_productos/<?php echo $row_rsarreglos1['imagen'];?>&h=200&w=140&zc=1 " alt="<?php echo $row_rsarreglos1['nombre_es']; ?>" border="0" >
          <img src="images/blank.gif" alt="<?php echo $row_rsarreglos1['nombre_es']; ?>" width="120" height="130" border="0" /></a></div>-->
<div class="foto" 
                style="background: url(<?php echo str_replace($buscar, $reempla,$objDynamicThumb5->Execute()); ?>) no-repeat center center;"><a href="arreglos-ver.php?id=<?php echo $row_rsarreglos1['id_producto']; ?>">
         ...
         <div class="texto"><a href="arreglos-ver.php?id=<?php echo $row_rsarreglos1['id_producto']; ?>"><?php echo $row_rsarreglos1['nombre_es']; ?><br/>
                <span class="style1">$<?php echo number_format($row_rsarreglos1['numerico2'],2); ?></span></a>
                 <br/>
  <?php 
