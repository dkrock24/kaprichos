...
mysql_select_db($database_conne10, $conne10);
$query_rsarreglos1 = "SELECT * FROM tbl_productos WHERE tbl_productos.estatus=1 ORDER BY rand() LIMIT 0,5";
...
$objDynamicThumb5->setResize(200, 0, true);
...
<title>Floristeria Kaprichos - Inicio</title>
<!-- InstanceEndEditable -->
    ...
    <table width="100%" border="0" cellspacing="10" cellpadding="0">
      <tr>
        ...
        <td valign="top"><!-- InstanceBeginEditable name="MAIN" -->
           ...
           </div><div id="peque" ><a href="categoria.php?c=<?php echo $row_rsrandomcat['id_categoria']?>"><img src="<?php echo $objDynamicThumb1->Execute();  ?>" id="imagen_r" border="0" /> <div class="texto"><?php echo $row_rsrandomcat['nombre_es']; ?></div></a>
              </div><br/>
               <div class="homebox3">
              <a href="categoria.php?c=<?php echo $row_rsrandomcat2['id_categoria']?>"> <img src="<?php echo $objDynamicThumb2->Execute();  ?>" id="imagen_r" border="0"/>
              <div class="texto"><?php echo $row_rsrandomcat2['nombre_es']; ?></div></a>
              </div>
            <br/><div class="homebox3" >
            <a href="categoria.php?c=<?php echo $row_rsrandomcat3['id_categoria']?>">
            <img src="<?php echo $objDynamicThumb3->Execute();  ?>" id="imagen_r" border="0"/>
    ...
    <div style="margin-top:10px;">
            <?php do { ?>
              <div class="boxarreglo" style="margin-right:10px;" >
                ...
                <?php /*$image="uploaded/mod_productos/".$row_rsarreglos1['imagen']; 
				echo "".$image;
				$img1=imagesx($objDynamicThumb1->Execute());
				echo "".$img1;*/
				?>
                <img  src="uploaded/mod_productos/<?php echo $row_rsarreglos1['imagen']; ?>" border="0" style="background-position:center center; background-repeat:no-repeat;" id="imagen_reducida"/>
                <img src="images/blank.gif" alt="<?php echo $row_rsarreglos1['nombre_es']; ?>" width="20" height="180" border="0" /></a></div>
