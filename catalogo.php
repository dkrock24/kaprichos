...
mysql_select_db($database_conne10, $conne10);
$query_rsarreglos1 = "SELECT * FROM tbl_productos_categorias WHERE tbl_productos_categorias.estatus='1' ORDER BY tbl_productos_categorias.orden ASC";
...
<div class="container">
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-3">
          <ul class="list-group">
            <li class="list-group-item d-flex justify-content-between align-items-center" style="background: #D82787;color: white;border-color: #e4e4e4;">
        ...
        <div class="col-sm-12 col-md-12 col-lg-9">
          <div class="list-group">
            <a href="#" class="list-group-item list-group-item-action" style="background: #D82787;color: white;border-color: #e4e4e4;">
              <span class="badge-pill"><h4><?php echo $messages['catalogL']; ?></h4></span>
            </a>
          </div>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            <li class="page-item">
                              ...
                              <a href="<?php printf("%s?pageNum_rsarreglos1=%d%s", $currentPage, 0, $queryString_rsarreglos1); ?>" class="fakab"><?php echo $messages['start']; ?></a>
                              <?php } // Show if not first page ?>
                            </li>
                            <li>
                                <?php if ($pageNum_rsarreglos1 > 0) { // Show if not first page ?>
                              <a href="<?php printf("%s?pageNum_rsarreglos1=%d%s", $currentPage, max(0, $pageNum_rsarreglos1 - 1), $queryString_rsarreglos1); ?>" class="fakab">«<?php echo $messages['preview']; ?></a>
                          <?php } // Show if not first page ?>
                            </li>
                            <li class="page-item">
                                <?php if ($pageNum_rsarreglos1 < $totalPages_rsarreglos1) { // Show if not last page ?>
                                <a href="<?php printf("%s?pageNum_rsarreglos1=%d%s", $currentPage, min($totalPages_rsarreglos1, $pageNum_rsarreglos1 + 1), $queryString_rsarreglos1); ?>" class="fakab"><?php echo $messages['next']; ?>»</a></li>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                do { 
                  ...
                  {       ?>
                    ...
                    <div class="col-md-3 product-left"  style=""> 
                        <div class="p-one simpleCart_shelfItem jwe" style="width: 100%;margin: 0 auto;" >                         
                                <a href="categoria.php?c=<?php echo $row_rsarreglos1['id_categoria']; ?>">
