...
<title>Catalogo-Floristeria Kaprichos</title>
<!-- InstanceEndEditable -->
...
<div id="layout_wrapper">
  ...
  <div id="layout_content">
    <table width="100%" border="0" cellspacing="10" cellpadding="0">
	  ...
	  do { ?>
<?php
list($width, $height, $type, $attr) = getimagesize("uploaded/mod_productos/".$row_rsarreglos1['imagen']);
?>
        <div class="boxarreglo">
          <div class="foto" style="background: url(<?php if($width >= $height) { ?><?php echo str_replace($buscar, $reempla, $objDynamicThumb2->Execute()); ?><?php } if($width < $height) { ?><?php echo str_replace($buscar, $reempla, $objDynamicThumb1->Execute()); ?><?php } ?>) no-repeat center center;"><a href="categoria.php?c=<?php echo $row_rsarreglos1['id_categoria']; ?>"><img src="images/blank.gif" width="140" height="200" border="0" /></a></div>
         <div class="texto"><a href="categoria.php?c=<?php echo $row_rsarreglos1['id_categoria']; ?>" class="style1"><?php echo $row_rsarreglos1['nombre_es']; ?></a></div>
        </div>
